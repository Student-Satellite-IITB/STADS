...
st_op_bi   = table2array(sm_output.op_bi);
st_op_ri   = table2array(sm_output.op_ri);
...
[m_B, v_z, lamnot] = es_quest_common_sim(st_op_bi_reduced, st_op_ri_reduced , v_a);
...
if q_bi == [-1; -1; -1; -1]
    ...
    q_bi = es_quest_1_seq_rot_sim(st_op_bi_reduced, st_op_ri_reduced , v_a, epsilon, es_seq_error, q_bi_prev);
end
