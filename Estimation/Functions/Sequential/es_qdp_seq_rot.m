function q_bi = es_qdp_seq_rot(b_m, m_r, v_a)
% This function calculates quaternion using q-Davenport after applying sequential rotation
% input: (b_m,m_r,v_a)
...
%%again applying the algorithm q-Davenport
q_bi = es_qdp(b_m, m_r, v_a);

%if the value of the returned quaternion is [-1;-1;-1;-1] then q-Davenport has 
