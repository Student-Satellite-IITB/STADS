...
1. https://github.com/1mitalee/STADS/blob/pdf-upload/Estimation/es_main_quest_2.m

**QA suggestions:**

1. Inputs to the estimation block must be modified before feeding them to the function es_quest_common.m, the first column must
be eliminated
