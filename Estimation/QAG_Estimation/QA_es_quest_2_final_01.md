...
**Date of review:**	09/05/20


**Permanent Links:**

1. https://github.com/1mitalee/STADS/blob/pdf-upload/Estimation/Functions/QuEST/es_quest_2_final.m

**QA suggestions:**

1. line 2: * quest2

2. line 12: syntax is incorrect, check matlab documentation

3. Definition of norm is different from what we need. Check documentation

4. Apply the condition that the division must be performed only when the norm is non- zero
