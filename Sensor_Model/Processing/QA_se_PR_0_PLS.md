...
1. https://github.com/Neilabh21/STADS_IITBSSP/blob/master/Sensor_Model/Processing/se_PR_6_Noise_Model/se_PR_0_PLS.m
...
1.  In the comments it is written to check whether it should be 1/Capture time or 1/Exposure time. According to the source material read, i feel it should be 1/Capture time.
2. In line 25 and 34, it says Photon Shot Noise - should change to PLS.
