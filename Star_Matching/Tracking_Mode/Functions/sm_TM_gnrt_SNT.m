function [sm_TM_SNT] = sm_TM_gnrt_SNT (sm_consts_TM, is_degree)
    ...
    %% Construct SNT
    for sm_star_ID = 1:size(sm_consts_TM.sm_GD_SC, 1)
        % Find Neighbour stars for each guide star
        sm_TM_SNT_vec = sm_TM_SNT_neighbours(sm_star_ID, sm_consts_TM.sm_PP_SC, sm_consts_TM.sm_TM_SNT_R, is_degree);
