function [arr_range_data, num_ranges]  = fe_extract_row_data(arr_row)
%{
input:
-arr_row:
...
%}
    ...
    arr_range_data = zeros(NUM_RANGES_ROW, 5);
    num_ranges = 0;
    range_bool = 0;
    ...
    for i_row = 1:BREADTH
        ...
        if intensity > THRESHOLD
            ...
            if range_bool == 1
                arr_range_data(num_ranges, 1:3) = arr_range_data(num_ranges, 1:3) + [intensity*i_row, intensity, 1];
        ...
        % range
        elseif range_bool == 1
            arr_range_data(num_ranges, 5) = i_row-1;
            range_bool  = 0;
        end
    end
