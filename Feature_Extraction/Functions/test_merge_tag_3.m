...
function testCoords(testCase)
    ...
    for I = 0:n
        ...
        [arr_star_coordinates, ~] = merge_tag_3(test_case_1(1), test_case_1(2), test_case_1(3), test_case_1(4), test_case_1(5), a(1), a(2));
...
function testConstants(testCase)
    ...
    for I = 0:n
        test_case_1 = load("C:/Users/aravi/OneDrive/Documents/MATLAB/test_cases/test_" +I+ "/sums.csv");
        a = load("C:/Users/aravi/OneDrive/Documents/MATLAB/test_cases/test_" +I+ "/constants.csv");
        [, num_stars] = merge_tag_3(test_case_1(1), test_case_1(2), test_case_1(3), test_case_1(4), test_case_1(5), a(1), a(2));
