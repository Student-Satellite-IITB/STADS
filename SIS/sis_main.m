...
for i = 1:1%sis_input.gen.N_bo %%%%%%
    ...
    imwrite(sis_Pixel_Val_Mat, sprintf('./SIS/Output/Simulation_%s/Image_%s/Image_%s.png', string(sis_input.gen.sim_N), string(i), string(i)));
